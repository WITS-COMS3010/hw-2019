...
int recur(int i) {      // a recursive function
    ...
    printf("recur call %d: stack@ %lx\n", i, j); // TODO: fix this so it prints the address of j
    if (i > 0) {
        return recur(i-1);
    }
    return 0;
...
int main (int argc, char *argv[]) {
    ...
    printf("_main  @ %lx\n", main);      // TODO: fix to print address of main
    printf("recur @ %lx\n", recur);      // TODO: fix to print address of recur
    printf("_main stack: %lx\n", i);     // TODO: fix to get address of the stack variable
    printf("static data: %lx\n", stuff); // TODO: fix to get address of a static variable
