...
1. What segment contains wc (the function) and what is its address? (hints: `objdump -x wc | grep wc`, `readelf -l wc`, and the theory at the top of <a href="https://github.com/cirosantilli/notes/blob/master/stack-overflow/section-vs-segment.md">these notes</a>)
1. What about main?
